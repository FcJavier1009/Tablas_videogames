...
def insertar_prestamo(fecha_prestamo, fecha_devolucion):
    conexion = conectar()
    cursor = conexion.cursor()
    cursor.execute('''INSERT INTO Prestamos (fecha_prestamo, fecha_devolucion) VALUES (?, ?, ?)''', (fecha_prestamo, fecha_devolucion))
